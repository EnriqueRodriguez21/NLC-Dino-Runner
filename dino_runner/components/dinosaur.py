...
from dino_runner.utils.constants import RUNNING, DUCKING, JUMPING, DEFAULT_TYPE, SHIELD_TYPE, HAMMER_TYPE, DUCKING_SHIELD, RUNNING_SHIELD, JUMPING_SHIELD, DUCKING_HAMMER, RUNNING_HAMMER, JUMPING_HAMMER
